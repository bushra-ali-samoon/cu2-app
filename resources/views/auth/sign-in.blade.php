     ...
     <form action="#" class="kt-card-content flex flex-col gap-5 p-10" id="sign_in_form" method="get">
      <div class="text-center mb-2.5">
       ...
       <div class="flex items-center justify-center font-medium">
        ...
        <a class="text-sm link" href="html/demo1/authentication/branded/sign-up.html">
         Sign up
        </a>
       </div>
      </div>
      ...
      <div class="flex flex-col gap-1">
       <div class="flex items-center justify-between gap-1">
        ...
        <a class="text-sm kt-link shrink-0" href="html/demo1/authentication/branded/reset-password/enter-email.html">
         Forgot Password?
        </a>
       </div>

...
<div class="flex justify-center items-center p-8 lg:p-10 order-2 lg:order-1">
    <div class="kt-card max-w-[370px] w-full">
        <form action="{{ route('signup.store') }}" method="POST" class="kt-card-content flex flex-col gap-5 p-10" id="sign_up_form">
            @csrf
            ...
            <div class="text-center mb-2.5">
                ...
                <div class="flex items-center justify-center">
                    ...
                    <a class="text-sm link" href="{{ url('/login') }}">Sign In</a>
                </div>
            </div>
            ...
            <div class="flex flex-col gap-1">
                ...
                <input class="kt-input" type="email" name="email" placeholder="email@email.com" value="{{ old('email') }}" required>
                @error('email')
            ...
            <div class="flex flex-col gap-1">
                ...
                <div class="kt-input" data-kt-toggle-password="true">
                    ...
                    <button type="button" class="kt-btn kt-btn-sm kt-btn-ghost kt-btn-icon bg-transparent! -me-1.5" data-kt-toggle-password-trigger="true">
            ...
            <label class="kt-checkbox-group">
                <input class="kt-checkbox kt-checkbox-sm" type="checkbox" name="terms" value="1" required>
